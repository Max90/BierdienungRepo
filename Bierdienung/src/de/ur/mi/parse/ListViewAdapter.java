...
public class ListViewAdapter extends BaseAdapter {
    ...
    public ListViewAdapter(Context context,
		...
		try {
            ...
            ArrayList<ParselistdownloadClass> arraylist = new ArrayList<ParselistdownloadClass>();
            arraylist.addAll(parselistdownloadList);
        } catch (Exception e) {
			e.printStackTrace();
		}
	...
	public View getView(final int position, View view, ViewGroup parent) {
		...
		TextView listviewName = (TextView) view
				.findViewById(R.id.text_view_name);
		TextView listviewPreis = (TextView) view
