...
public class SpeiseUndGetraenkeKartenActivity extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.speisekarte:
                Intent iEssen = new Intent(SpeiseUndGetraenkeKartenActivity.this,
            ...
            case R.id.getraenkekarte:
                Intent iGetraenke = new Intent(SpeiseUndGetraenkeKartenActivity.this,
                        SpeiseUndGetraenkeKartenActivity.class);
            ...
            case R.id.compute_table:
                Intent computeTableIntent = new Intent(SpeiseUndGetraenkeKartenActivity.this, AbrechnungsActivity.class);
    ...
    private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(SpeiseUndGetraenkeKartenActivity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            adapter = new ListViewAdapter(SpeiseUndGetraenkeKartenActivity.this,
