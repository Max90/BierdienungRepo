...
public class LoginSignupActivity extends Activity {
    ...
    private void setUI() {
        ...
        // Locate RadioButton
        radioCheck = (RadioGroup) findViewById(R.id.radio_group);
        radioWaiter = (RadioButton) findViewById(R.id.radio_waiter);
        radioKueche = (RadioButton) findViewById(R.id.radioKueche);
        radioAusschank = (RadioButton) findViewById(R.id.radio_bar);
        radioVerwalten = (RadioButton) findViewById(R.id.radio_management);
    }
